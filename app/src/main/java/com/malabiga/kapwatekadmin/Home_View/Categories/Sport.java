        ...
        notification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                rootRef.orderByChild("typeStatus").equalTo("Pending").addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        Intent i = new Intent(Sport.this, VOL_Notification_Post_Activity.class);
                        startActivity(i);
                    }
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                        ...
                        switch (id) {
                            case R.id.nav_home_admin:
                                Intent i = new Intent(Sport.this, Sport.class);
                                startActivity(i);
                                break;
                            case R.id.nav_view_vol:
                                Intent iii = new Intent(Sport.this, ViewVolunteersAccount.class);
                                startActivity(iii);
                                break;
                            case R.id.nav_view_company:
                                Intent ii = new Intent(Sport.this, ViewEmployeesAccount.class);
                                startActivity(ii);
                                break;
                            case R.id.nav_view_ngo:
                                Intent ii1 = new Intent(Sport.this, com.malabiga.kapwatekadmin.Approval.EMP_NGO_Approval.ViewEmployeesAccount.class);
                                startActivity(ii1);
                                break;
                            case R.id.nav_view_lgu:
                                Intent ii2 = new Intent(Sport.this, com.malabiga.kapwatekadmin.Approval.EMP_LGU_Approval.ViewEmployeesAccount.class);
                                startActivity(ii2);
                                break;
                            case R.id.nav_view_school:
                                Intent ii3 = new Intent(Sport.this, com.malabiga.kapwatekadmin.Approval.EMP_SCL_Approval.ViewEmployeesAccount.class);
                                startActivity(ii3);
                                break;
//                            case R.id.nav_logout_admin:
//
//                                AlertDialog.Builder alert = new AlertDialog.Builder(Sport.this);
...
//                                                startActivity(new Intent(Sport.this, LoginActivity.class));
//                                            }
...
//Call the Recycler View
        ...
        mDatabaseRef.orderByChild("category").equalTo("Sports, Team, and Clubs").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
//Call for the Model
                mPosts = new ArrayList<>();
...
//Call the View Class
                ...
                mAdapter = new ORG_Home_Cardview_Adapter(Sport.this, mPosts);
                mRecyclerView.setAdapter(mAdapter);
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(Sport.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
