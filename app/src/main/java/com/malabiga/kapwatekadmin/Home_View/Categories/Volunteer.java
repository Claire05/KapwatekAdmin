                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                        ...
                        switch (id) {
                            case R.id.nav_home_admin:
                                Intent i = new Intent(Volunteer.this, Volunteer.class);
                                startActivity(i);
                                break;
                            case R.id.nav_view_vol:
                                Intent iii = new Intent(Volunteer.this, ViewVolunteersAccount.class);
                                startActivity(iii);
                                break;
                            case R.id.nav_view_company:
                                Intent ii = new Intent(Volunteer.this, ViewEmployeesAccount.class);
                                startActivity(ii);
                                break;
                            case R.id.nav_view_ngo:
                                Intent ii1 = new Intent(Volunteer.this, com.malabiga.kapwatekadmin.Approval.EMP_NGO_Approval.ViewEmployeesAccount.class);
                                startActivity(ii1);
                                break;
                            case R.id.nav_view_lgu:
                                Intent ii2 = new Intent(Volunteer.this, com.malabiga.kapwatekadmin.Approval.EMP_LGU_Approval.ViewEmployeesAccount.class);
                                startActivity(ii2);
                                break;
                            case R.id.nav_view_school:
                                Intent ii3 = new Intent(Volunteer.this, com.malabiga.kapwatekadmin.Approval.EMP_SCL_Approval.ViewEmployeesAccount.class);
                                startActivity(ii3);
                                break;
//                            case R.id.nav_logout_admin:
//
//                                AlertDialog.Builder alert = new AlertDialog.Builder(Volunteer.this);
...
//                                                startActivity(new Intent(Volunteer.this, LoginActivity.class));
//                                            }
...
//Call the Recycler View
        ...
        mDatabaseRef.orderByChild("category").equalTo("Volunteer and Services").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
//Call for the Model
                mPosts = new ArrayList<>();
...
//Call the View Class
                ...
                mAdapter = new ORG_Home_Cardview_Adapter(Volunteer.this, mPosts);
                mRecyclerView.setAdapter(mAdapter);
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(Volunteer.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
